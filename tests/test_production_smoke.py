...
class TestProductionSmoke:
    ...
    def test_single_year_simulation(self):
        ...
        try:
            ...
            assert duration < 60, f"Single year simulation took {duration:.1f}s, expected <60s"
        ...
        with duckdb.connect("simulation.duckdb") as conn:
            ...
            if 'fct_yearly_events' in table_names:
                ...
                for col in required_columns:
                    assert col in column_names, f"Missing required column in fct_yearly_events: {col}"
            ...
            if 'fct_workforce_snapshot' in table_names:
                ...
                for col in required_columns:
                    assert col in column_names, f"Missing required column in fct_workforce_snapshot: {col}"
        ...
        with duckdb.connect("simulation.duckdb") as conn:
            ...
            for table in tables_to_check:
                try:
                    ...
                    assert count > 0, f"Table {table} should have data but found {count} rows"
                except Exception:
