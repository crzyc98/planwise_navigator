...
from orchestrator_mvp.core.id_generator import (
    UnifiedIDGenerator, create_id_generator_from_config,
...
class TestUnifiedEmployeeIdGeneration:
    ...
    def test_new_hire_deterministic_generation(self):
        ...
        id1 = gen1.generate_employee_id(
            sequence, is_baseline=False, hire_year=hire_year
        )
        id2 = gen2.generate_employee_id(
            sequence, is_baseline=False, hire_year=hire_year
        )
        id3 = gen3.generate_employee_id(
            sequence, is_baseline=False, hire_year=hire_year
        )
    ...
    def test_different_seeds_produce_different_ids(self):
        ...
        id_seed_42 = gen_42.generate_employee_id(
            sequence, is_baseline=False, hire_year=hire_year
        )
        id_seed_123 = gen_123.generate_employee_id(
            sequence, is_baseline=False, hire_year=hire_year
        )
        id_seed_999 = gen_999.generate_employee_id(
            sequence, is_baseline=False, hire_year=hire_year
        )
    ...
    def test_different_years_produce_different_ids(self):
        ...
        id_2025 = gen_2025.generate_employee_id(
            sequence, is_baseline=False, hire_year=2025
        )
        id_2026 = gen_2026.generate_employee_id(
            sequence, is_baseline=False, hire_year=2026
        )
        id_2027 = gen_2027.generate_employee_id(
            sequence, is_baseline=False, hire_year=2027
        )
    ...
    def test_different_sequences_produce_different_ids(self):
        ...
        id_seq_1 = generator.generate_employee_id(
            1, is_baseline=False, hire_year=hire_year
        )

        # Reset generator to avoid duplicate tracking
        generator.reset_generation_tracking()
        id_seq_100 = generator.generate_employee_id(
            100, is_baseline=False, hire_year=hire_year
        )

        generator.reset_generation_tracking()
        id_seq_999 = generator.generate_employee_id(
            999, is_baseline=False, hire_year=hire_year
        )
    ...
    def test_baseline_vs_new_hire_format_differences(self):
        ...
        generator.reset_generation_tracking()
        new_hire_id = generator.generate_employee_id(
            sequence, is_baseline=False, hire_year=year
        )
    ...
    def test_uniqueness_within_realistic_simulation(self):
        ...
        for i in range(1, num_hires + 1):
            emp_id = generator.generate_employee_id(
                i, is_baseline=False, hire_year=hire_year
            )
        ...
        assert len(generated_ids) == len(
            unique_ids
        ), f"Expected {len(generated_ids)} unique IDs, got {len(unique_ids)}"
    ...
    def test_format_validation_methods(self):
        ...
        generator.reset_generation_tracking()
        new_hire_id = generator.generate_employee_id(
            1, is_baseline=False, hire_year=2025
        )
    ...
    def test_config_factory_function(self):
        ...
        config = {"random_seed": 123, "base_year": 2024}
...
class TestEmployeeIdBatchValidation:
    ...
    def test_validation_passes_with_unique_ids(self):
        ...
        employee_ids = ["EMP_2024_000001", "NH_2025_abc12345_000002", "EMP_2024_000003"]
    ...
    def test_cross_format_uniqueness(self):
        ...
        new_hire_ids = gen_new_hire.generate_batch_employee_ids(
            1, 10, is_baseline=False, hire_year=2025
        )
