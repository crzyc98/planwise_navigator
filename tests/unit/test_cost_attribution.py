...
class TestCostAttributionEntry:
    ...
    def test_attribution_basis_validation(self):
        ...
        with pytest.raises(ValueError, match="Attribution basis must be at least 10 characters"):
            CostAttributionEntry(
                employee_id="EMP001",
                scenario_id="SCENARIO_001",
                plan_design_id="DESIGN_001",
...
class TestCrossYearCostAttributor:
    ...
    def test_cost_attributor_initialization(self, cost_attributor):
        ...
        assert cost_attributor.default_allocation_strategy == AllocationStrategy.PRO_RATA_TEMPORAL
    ...
    def test_attribute_compensation_costs_across_years(self, cost_attributor, mock_allocation_context):
    ...
    def test_validate_attribution_integrity(self, cost_attributor, mock_allocation_context):
    ...
    def test_calculate_total_compensation_impact(self, cost_attributor):
        ...
        expected_total = Decimal('80000.00') + Decimal('10000.00') + Decimal('75000.00')  # Termination placeholder
...
class TestFactoryFunctions:
    ...
    def test_create_cost_attributor(self):
        ...
        assert attributor.default_allocation_strategy == AllocationStrategy.PRO_RATA_WORKFORCE
    ...
    def test_create_allocation_context(self):
        ...
        assert context.allocation_strategy == AllocationStrategy.HYBRID_TEMPORAL_WORKFORCE
        assert context.source_workforce_metrics == source_metrics
