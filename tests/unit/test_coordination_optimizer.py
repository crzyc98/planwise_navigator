...
from orchestrator_mvp.core.coordination_optimizer import (
    BottleneckAnalysis, BottleneckType, CoordinationOptimizer,
    OptimizationPhase, OptimizationStrategy, OptimizationTask,
    PerformanceMetrics, PerformanceProfiler, create_coordination_optimizer,
...
from orchestrator_mvp.core.state_management import (WorkforceMetrics,
...
class TestCoordinationOptimizer:
    ...
    def test_coordination_optimizer_initialization(
        self, coordination_optimizer, mock_cache_manager
    ):
        """Test coordination optimizer initialization."""
        assert (
            coordination_optimizer.optimization_strategy
    ...
    def test_optimize_multi_year_coordination(
        self, coordination_optimizer, mock_state_manager, mock_cost_attributor
    ):
    ...
    def test_optimize_event_processing(
        self, coordination_optimizer, mock_state_manager
    ):
    ...
    def test_optimize_state_transitions(
        self, coordination_optimizer, mock_state_manager
    ):
    ...
    def test_optimize_cost_attribution(
        self, coordination_optimizer, mock_cost_attributor
    ):
    ...
    def test_optimize_cache_management(
        self, coordination_optimizer, mock_cache_manager
    ):
    ...
    def test_analyze_optimization_impact(self, coordination_optimizer):
        ...
        assert (
            abs(float(analysis["overhead_reduction_percent"]) - expected_overhead) < 0.1
        )
    ...
    def test_calculate_performance_grade(self, coordination_optimizer):
        ...
        for overhead_reduction, expected_grade in test_cases:
            grade = coordination_optimizer._calculate_performance_grade(
                overhead_reduction
            )
    ...
    def test_optimization_error_handling(self, coordination_optimizer):
        ...
        with patch.object(
            coordination_optimizer, "_optimize_event_processing"
        ) as mock_event_opt:
...
class TestFactoryFunctions:
    ...
    def test_create_performance_profiler(self):
        ...
        profiler = create_performance_profiler(
            detailed_profiling=False, monitoring_interval=2.0
        )
...
class TestPerformanceTargets:
    ...
    def test_sub_second_state_transitions(self):
        ...
        result = optimizer._optimize_state_transitions(
            mock_state_manager, simulation_years
        )
