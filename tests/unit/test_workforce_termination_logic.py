...
class TestWorkforceTerminationLogic:
    ...
    def test_experienced_employee_terminations(self):
        ...
        with patch('duckdb.connect') as mock_connect:
            ...
            assert expected_active_count == 2, "Expected 2 active employees after termination"
    ...
    def test_new_hire_terminations(self):
        ...
        baseline_data = pd.DataFrame(columns=[
            'employee_id', 'employee_ssn', 'employee_birth_date', 'employee_hire_date',
            'current_compensation', 'current_age', 'current_tenure', 'level_id',
        ...
        termination_events = pd.DataFrame({
            'employee_id': ['NH001'],  # Terminate NH001 (hired and terminated same year)
            'simulation_year': [2025],
            'event_type': ['termination'],
        ...
        with patch('duckdb.connect') as mock_connect:
            ...
            assert expected_new_hire_terminations == 1, "Expected 1 new hire termination"
    ...
    def test_workforce_count_accuracy(self):
        ...
        baseline_data = pd.DataFrame({
            ...
            'employee_ssn': ['100-10-0001', '100-10-0002', '100-10-0003', '100-10-0004'],
            'employee_birth_date': ['1990-01-01', '1985-05-15', '1992-12-31', '1988-08-20'],
            'employee_hire_date': ['2020-01-01', '2018-03-01', '2021-06-01', '2019-11-15'],
        ...
        events_data = pd.DataFrame({
            ...
            'effective_date': ['2025-04-01', '2025-07-01', '2025-05-15', '2025-10-01'],
        ...
        assert expected_final_active == 4, f"Expected 4 final active employees, got {expected_final_active}"

        # Validate variance calculation
        expected_variance = 0  # Should be zero with correct logic
        assert expected_variance == 0, "Expected zero variance between events and workforce counts"
    ...
    def test_edge_cases(self):
        ...
        assert expected_edge_status == 'terminated', "Same-day hire/termination should be terminated"
        assert expected_boundary_status == 'terminated', "Year boundary termination should be terminated"
    ...
    def test_detailed_status_codes(self):
        ...
        for scenario in test_scenarios:
            ...
            if scenario['employment_status'] == 'active' and scenario['hire_year'] == scenario['current_year']:
                actual_code = 'new_hire_active'
            elif scenario['employment_status'] == 'terminated' and scenario['hire_year'] == scenario['current_year']:
                actual_code = 'new_hire_termination'
            elif scenario['employment_status'] == 'active' and scenario['hire_year'] < scenario['current_year']:
            ...
            assert actual_code == scenario['expected_status_code'], \
