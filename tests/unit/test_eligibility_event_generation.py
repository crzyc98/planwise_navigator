...
class TestEligibilityEventGeneration:
    ...
    def test_multiple_hires_generate_eligibility_events(self):
        ...
        eligibility_ids = {e['employee_id'] for e in events if e['event_type'] == 'eligibility'}
    ...
    def test_eligibility_event_fields(self):
        ...
        required_fields = [
            ...
            'level_id', 'age_band', 'tenure_band', 'event_probability',
            'event_category', 'event_sequence', 'created_at',
            'parameter_scenario_id', 'parameter_source', 'data_quality_flag'
        ]
