  ...
  return (
    <div className="space-y-3 rounded-xl border border-border bg-surface-raised p-4">
      <form onSubmit={submit} className="grid gap-2 md:grid-cols-3 lg:grid-cols-6">
        ...
        <button className="rounded bg-fidelity-green px-3 py-2 font-medium text-ink-inverse">Find employees</button>
      ...
      ) : total === 0 && (q || status || level || year || enrolled || escalations) ? <p className="text-sm text-ink-muted">No employees match these filters.</p> : null}
