...
-- Reintroduced from int_deferral_rate_escalation_events without creating circular dependencies.
-- This enables downstream registries and audits to consume escalation events via the unified fact.
