...
{{ log("DEBUG int_workforce_previous_year: simulation_year = " ~ simulation_year, info=true) }}
{{ log("DEBUG int_workforce_previous_year: previous_year = " ~ previous_year, info=true) }}
