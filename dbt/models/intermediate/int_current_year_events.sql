...
{{ config(
  ...
  tags=['EVENT_GENERATION', 'EVENT_PUBLICATION']
) }}

-- Current-year event assembly is kept separate from durable publication so
-- the event candidate graph has one explicit SQL boundary.
