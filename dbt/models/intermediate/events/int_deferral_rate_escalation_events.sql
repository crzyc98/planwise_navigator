...
WITH active_workforce AS (
    SELECT
        ...
        w.level_id,
        w.employment_status,
        w.employee_deferral_rate as baseline_deferral_rate,
        w.simulation_year
...
-- Get enrollment status from enrollment events (no circular dependency)
...
workforce_with_status AS (
    SELECT
        ...
        COALESCE(w.baseline_deferral_rate, 0) + COALESCE(h.cumulative_escalation_rate, 0) as current_deferral_rate,
        -- Escalation history
        ...
        CASE
            ...
            THEN DATE_DIFF('day', h.last_escalation_date, DATE('{{ simulation_year }}-01-01'))
        ...
        CASE
            ...
            THEN DATE_DIFF('year', e.first_enrollment_date, DATE('{{ simulation_year }}-01-01'))
            ELSE 0
