"""
Status command for Fidelity PlanAlign Engine CLI
...
def show_status(
    ...
    console.print("🔍 [bold blue]Fidelity PlanAlign Engine Status[/bold blue]")
...
def _display_status_overview(status_info: dict):
    ...
    if version_info.get("release_name"):
        version_str += f" ({version_info['release_name']})"
