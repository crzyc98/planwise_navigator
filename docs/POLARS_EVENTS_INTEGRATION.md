...
The Polars Events integration provides a high-performance alternative to SQL-based event generation in Fidelity PlanAlign Engine. This integration allows dbt to seamlessly read event data generated by the Polars bulk event factory while maintaining compatibility with existing SQL-based workflows.
...
The Polars events source is designed to integrate seamlessly with the existing PlanAlign Orchestrator pipeline. See Epic E068G implementation for full integration details.
