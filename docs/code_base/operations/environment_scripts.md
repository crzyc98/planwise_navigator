...
The environment management scripts provide essential utilities for setting up, configuring, and maintaining the PlanWise Navigator development and production environments. These scripts ensure consistent deployment, proper configuration, and reliable system operation.
...
#!/bin/bash
"""
Set DAGSTER_HOME environment variable system-wide for PlanWise Navigator
...
# PlanWise Navigator Dagster Configuration
...
main() {
    ...
    for arg in "$@"; do
        case $arg in
            ...
            --help|-h)
                ...
                echo ""
                echo "Set DAGSTER_HOME environment variable for PlanWise Navigator"
                echo ""
                echo "Options:"
    ...
    log_info "Setting up DAGSTER_HOME for PlanWise Navigator"
...
#!/bin/bash
"""
Start Dagster development server for PlanWise Navigator
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help)
            ...
            echo ""
            echo "Start Dagster development server for PlanWise Navigator"
            echo ""
            echo "Options:"
...
check_dependencies() {
    ...
    if [[ ! -f "$PROJECT_ROOT/definitions.py" ]]; then
        ...
        log_info "Make sure you're running this script from the PlanWise Navigator root directory"
        return 1
    fi
...
start_dagster_dev() {
    ...
    log_info "Host: $HOST"
    log_info "Port: $PORT"
    log_info "Project: PlanWise Navigator"
...
# Main execution
main() {
    log_info "Starting Dagster development server for PlanWise Navigator"
...
#!/bin/bash
"""
Start PlanWise Navigator Streamlit Dashboard
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help)
            ...
            echo ""
            echo "Start PlanWise Navigator Streamlit Dashboard"
            echo ""
            echo "Options:"
...
start_dashboard() {
    log_info "Starting PlanWise Navigator Dashboard..."
    log_info "Host: $HOST"
    log_info "Port: $PORT"
...
#!/bin/bash
"""
Install and configure Python virtual environment for PlanWise Navigator
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help)
            echo "Usage: $0 [OPTIONS]"
            echo ""
            echo "Install Python virtual environment for PlanWise Navigator"
            echo ""
            echo "Options:"
...
create_activation_script() {
    ...
    cat > "$script_path" << EOF
#!/bin/bash
# PlanWise Navigator Environment Activation
...
echo "✅ PlanWise Navigator environment activated"
...
main() {
    log_info "Setting up PlanWise Navigator Python environment"
