...
pytest tests/ --cov=planalign_orchestrator --cov=planalign_cli --cov=planalign_api --cov=config \
  --cov-report=xml --cov-report=term

# Fast tests only (with coverage)
pytest -m "not slow" --cov=planalign_orchestrator --cov=planalign_cli --cov=planalign_api --cov=config \
  --cov-report=xml --cov-report=term
```
